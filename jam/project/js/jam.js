...
//            }
    ...
    $.extend(Item.prototype, {
        ...
        do_before_open: function(expanded, fields, where, order_by, open_empty, params, funcs, group_by) {
            var result,
                i,
                len,
                field,
        ...
        open: function() {
            ...
            if (this.master) {
                if (!this.disabled && this.master.record_count() > 0) {
                    ...
                    if (records !== undefined) {
                        if (this.do_before_open(expanded, fields, where, order_by, open_empty, params, funcs, group_by) !== false) {
            ...
            if (offset !== undefined) {
                ...
                offset = 0
                result = this.do_before_open(expanded, fields, where, order_by, open_empty, params, funcs, group_by);
                this.bind_fields(expanded);
            }
            if (result !== false) {
        ...
        createTable: function() {
            ...
            this.$element.on('mousedown.grid-title', 'table.outer-table thead tr:first th', function(e) {
                ...
                if ($this.outerWidth() - e.offsetX < 8 && this !== lastCell) {
                    ...
                    if (self.item.master || !self.item.auto_loading) {
